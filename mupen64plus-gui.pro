...
SOURCES += osal/osal_dynamiclib_win32.c \
    ...
    win32-msvc* {
        ...
        DEFINES -= UNICODE
        LIBS += -Wl,-Bdynamic -L"C:\projects\mupen64plus-gui\SDL2-2.0.6\x86_64-w64-mingw32\lib" -lSDL2
        INCLUDEPATH += /mingw64/include/SDL2 /mingw32/include/SDL2 C:\projects\mupen64plus-gui\SDL2-2.0.6\x86_64-w64-mingw32\include\SDL2
    }
}
